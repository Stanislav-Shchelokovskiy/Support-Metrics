...
class SqlServerFactory:
    ...
    def create_tracked_groups_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = customers_groups.TrackedCustomersGroups())

    def create_tags_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.TicketsTags())

    def create_replies_types_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = cat.CATRepliesTypes())

    def create_components_features_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = cat.CATComponentsFeatures())

    def create_customers_tickets_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets_and_iterations.CustomersTickets())

    def create_license_statuses_repository(self, **kwargs) -> Repository:
        return licenses_conversion.LicenseStatusesRepository()

    def create_conversion_statuses_repository(self, **kwargs) -> Repository:
        return licenses_conversion.ConversionStatusesRepository()

    def create_platforms_products_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = platforms_products.PlatformsProducts())

    def create_employees_iterations_repository(self, **kwargs)-> SqlServerRepository:
        return self._create_repository(queries = tickets_and_iterations.EmployeesIterations())

    def create_tickets_types_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.TicketsTypes())

    def create_frameworks_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.Frameworks())

    def create_operating_systems_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.OperatingSystems())

    def create_builds_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.Builds())

    def create_severity_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.Severity())

    def create_ticket_statuses_repository(self, **kwargs) -> SqlServerRepository:
        return self._create_repository(queries = tickets.TicketStatuses())

    def create_ides_repository(self, **kwargs) -> SqlServerRepository:
