...
@params_guard
def generate_emp_tribes_filter(params: FilterParametersNode, col: str = TicketsWithIterations.emp_tribe_id) -> str:
    generate_filter = SqlFilterClauseFromFilterParametersGeneratorFactory.get_in_filter_generator(
        params
    )
    return generate_filter(
...
def generate_emp_tents_filter(params: FilterParametersNode) -> str:
    return generate_emp_tribes_filter(params=params, col=TicketsWithIterations.emp_tent_id)


@params_guard
def generate_employees_filter(params: FilterParametersNode, col: str = TicketsWithIterations.emp_scid) -> str:
    generate_filter = SqlFilterClauseFromFilterParametersGeneratorFactory.get_in_filter_generator(
        params
    )
    return generate_filter(
